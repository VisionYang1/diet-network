...
@Component({
  selector: 'app-rewardsdec',
  templateUrl: './RewardsDec.component.html',
  styleUrls: ['./RewardsDec.component.css'],
  providers: [RewardsDecService]
})
export class RewardsDecComponent implements OnInit {
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceRewardsDec.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceRewardsDec.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
